<script lang="ts">
	...
	import { projects, uiShots } from '$lib/data/projects';
	...
	<div class="h-96 flex justify-center my-28 w-full">
		<div class="md:container w-full flex flex-col gap-8">
			<div class="flex flex-col gap-6">
				...
				<p class="text-xl md:text-2xl font-light">🔨 Still in progress...</p>
			</div>
...
<div class="border-t border-base-300 w-full pt-12 mt-12">
	<div class="container">
		...
		<div>
			<div class="p-2 flex flex-col gap-2 mb-6">
				<h4 class="text-2xl font-medium">UI/UX Designs</h4>
				<p>
					All of the projects I have made so far are also designed by me, here are some designs I
					have made so far.
				</p>
			</div>

			<div class="flex flex-row flex-wrap gap-4 w-full">
				{#each uiShots as shot}
					<a href={shot.url} class="w-full md:w-1/3 lg:w-1/4">
						<img src={shot.image} alt="UI shot" class="rounded-lg w-full h-full object-cover" />
					</a>
				{/each}
			</div>
		</div>
